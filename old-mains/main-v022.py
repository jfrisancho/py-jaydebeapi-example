...
Examples:
  ...
  Silent unattended mode (automation/scripting):
    ...
    python main.py --approach RANDOM --method SIMPLE --coverage-target 0.3 --fab M15 --unattended
        """
    )
...
def unattended_mode(args) -> None:
    ...
    try:
        ...
        result = execute_run_with_config(config, toolset, verbose_mode)
...
def interactive_mode():
    ...
    try:
        ...
        result = execute_run_with_config(config, toolset, verbose)
