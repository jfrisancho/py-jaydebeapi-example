...
def clear_existing_toolsets(db: Database) -> int:
    """
...
def insert_toolsets(db: Database, toolsets_data: List[Tuple]) -> int:
    """
...
def validate_toolsets_data(toolsets_data: List[Tuple]) -> List[Tuple]:
    """
...
def main():
    ...
    try:
        ...
        # Validate data
        print("\nValidating data...")
        valid_data = validate_toolsets_data(raw_data)
        ...
        clear_existing_toolsets(db)
        
        # Insert new data
        print("\nInserting toolsets...")
        inserted_count = insert_toolsets(db, valid_data)
