...
CREATE TABLE tb_toolsets (
    ...
    name VARCHAR(128),                  -- Optional name not used in the system
...
CREATE INDEX idx_eq_conn_from_to ON tb_equipment_poc_connections (from_equipment_id, to_equipment_id);
CREATE INDEX idx_eq_conn_path_id ON tb_equipment_poc_connections (path_id);
